...
// Preset di topologie per il generatore sintetico (Passo 11, estensione):
// "medium" e' il grafo reale usato anche da ROS/Gazebo, "small"/"large"
// vivono solo in config/presets/ e servono solo al carico sintetico.
const PRESETS = {
