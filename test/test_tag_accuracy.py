...
volutamente tollerante (i valori numerici attesi devono comparire da
qualche parte nella risposta, non serve un match esatto di nomi colonna/
ordine righe): quello che conta e' se il TAG ha calcolato i numeri giusti,
non se ha fraseggiato la query in modo identico a quella di riferimento.
"""
import pytest
